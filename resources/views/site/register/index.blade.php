...
<body>
        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="HEAD" id="signup-form" class="signup-form" action="{{ route('site.register.getIndex') }}" >
    ...
    <!-- JS -->
    <script src="{{asset('global')}}/colorlib-regform-8/vendor/jquery/jquery.min.js"></script>
